...
export default function AdminProductos() {
  ...
  const handleFileSelect = async (type, file, targetState = "nuevo") => {
    ...
    // subir archivo
    try {
      const url = await uploadFileAndGetURL(file, "productos", (prog) =>
  ...
  const crearProducto = async () => {
    ...
    if (!nuevo.imageDetail.trim())
      return alert("La imagen de detalle es obligatoria");
    ...
    try {
      ...
      // guardar el id dentro del mismo producto
                ...
                <div className="image-uploader">
                  ...
                  <div className="uploader-preview">
                    {previewImage.imageDetail ? (
                      <img
                        src={previewImage.imageDetail}
                        alt="preview"
                        className="uimg"
                      />
                    ) : nuevo.imageDetail ? (
                      <img
                        src={nuevo.imageDetail}
                        alt="current"
                        className="uimg"
                      />
                    ) : (
                    ...
                    {uploadProgress.imageDetail > 0 &&
                      uploadProgress.imageDetail < 100 && (
                  ...
                  <div className="uploader-preview">
                    {previewImage.imageBack ? (
                      ...
                      <div className="u-placeholder">
                        Seleccioná una imagen (opcional)
                      </div>
                    )}
                    {uploadProgress.imageBack > 0 &&
                      uploadProgress.imageBack < 100 && (
                    ...
                    <div className="image-uploader">
                      ...
                      <div className="uploader-preview">
                        ...
                        {uploadProgress.imageBack > 0 &&
                          uploadProgress.imageBack < 100 && (
                            <progress
                              value={uploadProgress.imageBack}
                              max="100"
                            >
                              {uploadProgress.imageBack}%
                            </progress>
                    ...
                    <div className="image-uploader">
                      ...
                      <div className="uploader-preview">
                        ...
                        {uploadProgress.imageDetail > 0 &&
                          uploadProgress.imageDetail < 100 && (
                            <progress
                              value={uploadProgress.imageDetail}
                              max="100"
                            >
                              {uploadProgress.imageDetail}%
                            </progress>
